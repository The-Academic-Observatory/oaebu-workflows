...
OAEBU_DATA_PARTNERS = dict(
    ...
    muse_country=DataPartner(
        type_id="muse_country",
        bq_dataset_id="muse",
        bq_table_name="muse_country",
        isbn_field_name="isbn",
        title_field_name="title",
        sharded=False,
        schema_path=os.path.join(schema_folder(workflow_module="muse_telescope"), "muse_country.json"),
    ...
    muse_institution=DataPartner(
        type_id="muse_institution",
        bq_dataset_id="muse",
        bq_table_name="muse_institution",
        isbn_field_name="isbn",
        title_field_name="title",
        sharded=False,
        schema_path=os.path.join(schema_folder(workflow_module="muse_telescope"), "muse_institution.json"),
        schema_directory=os.path.join(schema_folder(workflow_module="muse_telescope")),
        sql_directory=os.path.join(sql_folder(workflow_module="muse_telescope")),
        book_product_functions=True,
        export_author=False,
