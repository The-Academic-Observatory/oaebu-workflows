...
.. glossary::
    ...
    Crossref	
       Crossref is a Digital Object Identifier (DOI) Registration Agency of the International DOI Foundation, that makes metadata available for all DOIs registered with them [1]_
    ...
    Google Books	
       Google Books provides paid and free (open access) eBooks [3]_
    ...
    OAPEN IRUS-UK	
       OAPEN IRUS-UK – a service for capturing and processing institutional repository usage data, making it possible for institutional repositories to generate COUNTER compliant usage data [8]_

    open access	
       Open access (OA) is free access to information, and unrestricted use of electronic resources for all [9]_
    ...
    telescope	
       A telescope is a data workflow that fetches and ingests data from a data source. Some telescopes run workflows that process and output data to other places. [12]_ Workflows are built on top of Apache Airflow's Directed Acyclic Graph (DAGs), where a DAG is “a collection of organized tasks that you want to schedule and run” [13]_ 



.. [1] https://www.crossref.org/community/

.. [2] https://www.elastic.co/elasticsearch/	

.. [3] https://play.google.com/books/publish/	

.. [4] https://about.jstor.org/librarians/books/open-access-books-jstor/	

.. [5] https://www.elastic.co/kibana/	

.. [6] https://educopia.org/data_trust/	

.. [7] https://www.oapen.org/oapen/1891940-organisation	

.. [8] https://www.jisc.ac.uk/irus	

.. [9] https://en.unesco.org/open-access/what-open-access	

.. [10] https://bisg.org/general/custom.asp?page=ONIXforBooks	

.. [11] https://en.wikipedia.org/wiki/Shard_(database_architecture)

.. [12] https://github.com/The-Academic-Observatory/oaebu-workflows

.. [13] https://cloud.google.com/composer/docs/run-apache-airflow-dag
