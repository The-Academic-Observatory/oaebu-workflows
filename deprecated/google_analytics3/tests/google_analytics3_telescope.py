...
class TestGoogleAnalytics3Telescope(ObservatoryTestCase):
        ...
        env = ObservatoryEnvironment(
            workflows=[
                Workflow(
                    ...
                    class_name="dags.oaebu_workflows.google_analytics3_telescope.google_analytics3_telescope.GoogleAnalytics3Telescope",
                    cloud_workspace=self.fake_cloud_workspace,
    ...
    @patch("dags.oaebu_workflows.google_analytics3_telescope.google_analytics3_telescope.build")
    @patch("dags.oaebu_workflows.google_analytics3_telescope.google_analytics3_telescope.ServiceAccountCredentials")
