...
def get_workflow_info(api: ObservatoryApi):
    ...
    workflow_info["DOAB Telescope"] = Workflow(
        name="DOAB Telescope", workflow_type=WorkflowType(id=wftids["doab"]), extra={}, tags=None
    )
    workflow_info["OAPEN Metadata Telescope"] = Workflow(
        name="OAPEN Metadata Telescope", workflow_type=WorkflowType(id=wftids["oapen_metadata"]), extra={}, tags=None
    )
    ...
    workflow_info["ANU Press ONIX Telescope"] = Workflow(
        ...
        workflow_type=WorkflowType(id=wftids["onix"]),
    ...
    workflow_info["Wits University Press ONIX Telescope"] = Workflow(
        name="Wits University Press ONIX Telescope",
    ...
    workflow_info["ANU Press Google Analytics Telescope"] = Workflow(
        ...
        organisation=Organisation(id=orgids["ANU Press"]),
        workflow_type=WorkflowType(id=wftids["google_analytics"]),
    ...
    workflow_info["ANU Press JSTOR Telescope"] = Workflow(
        ...
        organisation=Organisation(id=orgids["ANU Press"]),
        workflow_type=WorkflowType(id=wftids["jstor"]),
    ...
    workflow_info["UCL Press UCL Discovery Telescope"] = Workflow(
        ...
        organisation=Organisation(id=orgids["UCL Press"]),
        workflow_type=WorkflowType(id=wftids["ucl_discovery"]),
        extra={},
        tags='["oaebu"]',
    )
    workflow_info["ANU Press ONIX Workflow"] = Workflow(
        ...
        organisation=Organisation(id=orgids["ANU Press"]),
        workflow_type=WorkflowType(id=wftids["onix_workflow"]),
        extra={},
        tags='["oaebu"]',
    )
