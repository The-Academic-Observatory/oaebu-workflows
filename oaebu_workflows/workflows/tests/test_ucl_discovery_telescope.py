...
class TestUclDiscoveryTelescope(ObservatoryTestCase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.download_cassette = test_fixtures_folder("ucl_discovery", "download_cassette.yaml")
        self.test_table = test_fixtures_folder("ucl_discovery", "test_table.json")
...
class TestGetIsbnEprintMappings(TestCase):
    ...
    @patch("oaebu_workflows.workflows.ucl_discovery_telescope.service_account")
    @patch("oaebu_workflows.workflows.ucl_discovery_telescope.BaseHook.get_connection")
    @patch("oaebu_workflows.workflows.ucl_discovery_telescope.discovery.build")
