        ...
        with env.create():
            ...
            expected_dag_structure = {
                ...
                "create_oaebu_book_table": [
                    ...
                    "create_oaebu_intermediate_table_google_analytics_III",
                ...
                "create_oaebu_intermediate_table_google_analytics_III": ["create_oaebu_book_product_table"],
                "create_oaebu_book_product_table": [
                    ...
                    "create_oaebu_data_qa_intermediate_unmatched_google_analytics_III",
                    ...
                    "create_oaebu_data_qa_isbn_google_analytics_III",
                ...
                "create_oaebu_data_qa_isbn_google_analytics_III": ["export_oaebu_qa_metrics"],
                "create_oaebu_data_qa_intermediate_unmatched_google_analytics_III": ["export_oaebu_qa_metrics"],
        ...
        with env.create(task_logging=True):
            ...
            with env.create_dag_run(workflow_dag, execution_date):
                ...
                self.assert_table_content(
                    table_id,
                    load_and_parse_json(test_fixtures_folder("onix_workflow", "e2e_outputs", "onix_workid_isbn.json")),
                    primary_key="isbn13",
                )
                table_id = bq_sharded_table_id(
                ...
                self.assert_table_content(
                    table_id,
                    load_and_parse_json(
                        test_fixtures_folder("onix_workflow", "e2e_outputs", "onix_workid_isbn_errors.json")
                    ),
                    primary_key="Error",
                )
                table_id = bq_sharded_table_id(
                ...
                self.assert_table_content(
                    table_id,
                    load_and_parse_json(
                        test_fixtures_folder("onix_workflow", "e2e_outputs", "onix_workfamilyid_isbn.json")
                    ),
                    primary_key="isbn13",
                )
                ...
                self.assert_table_content(
                    table_id,
                    load_and_parse_json(test_fixtures_folder("onix_workflow", "e2e_outputs", "crossref_metadata.json")),
                    primary_key="DOI",
                )
                ...
                self.assert_table_content(
                    table_id,
                    load_and_parse_json(test_fixtures_folder("onix_workflow", "e2e_outputs", "book.json")),
                    primary_key="isbn",
                )
