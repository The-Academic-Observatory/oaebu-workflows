...
def get_dataset_type_info(api: ObservatoryApi):
    ...
    dataset_type_info["oapen_metadata"] = DatasetType(
        type_id="oapen_metadata", name="OAPEN Metadata", table_type=TableType(id=ttids["regular"])
    )
    dataset_type_info["onix"] = DatasetType(type_id="onix", name="Onix", table_type=TableType(id=ttids["sharded"]))
    dataset_type_info["google_analytics"] = DatasetType(
        type_id="google_analytics",
        name="Google Analytics",
        extra={"isbn_field_name": "publication_id", "title_field_name": "title"},
        table_type=TableType(id=ttids["partitioned"]),
    )
    dataset_type_info["google_books_sales"] = DatasetType(
        type_id="google_books_sales",
        name="Google Books Sales",
        extra={"isbn_field_name": "Primary_ISBN", "title_field_name": "Title"},
        table_type=TableType(id=ttids["partitioned"]),
    )
    dataset_type_info["google_books_traffic"] = DatasetType(
        type_id="google_books_traffic",
        name="Googl Books Traffic",
        extra={"isbn_field_name": "Primary_ISBN", "title_field_name": "Title"},
        table_type=TableType(id=ttids["partitioned"]),
    )
    dataset_type_info["jstor_country"] = DatasetType(
        type_id="jstor_country",
        name="JSTOR Country",
        extra={"isbn_field_name": "eISBN", "title_field_name": "Book_Title"},
        table_type=TableType(id=ttids["partitioned"]),
    )
    dataset_type_info["jstor_institution"] = DatasetType(
        type_id="jstor_institution",
        name="JSTOR Institution",
        extra={"isbn_field_name": "eISBN", "title_field_name": "Book_Title"},
        table_type=TableType(id=ttids["partitioned"]),
    )
    dataset_type_info["oapen_irus_uk"] = DatasetType(
        type_id="oapen_irus_uk",
        name="OAPEN IRUS UK",
        extra={"isbn_field_name": "ISBN", "title_field_name": "book_title"},
        table_type=TableType(id=ttids["partitioned"]),
    )
    dataset_type_info["ucl_discovery"] = DatasetType(
        type_id="ucl_discovery", name="UCL Discovery", table_type=TableType(id=ttids["partitioned"])
    )
    dataset_type_info["onix_workflow"] = DatasetType(
        type_id="onix_workflow", name="ONIX Workflow", table_type=TableType(id=ttids["partitioned"])
    )
    dataset_type_info["oapen_workflow"] = DatasetType(
        type_id="oapen_workflow", name="OAPEN Workflow", table_type=TableType(id=ttids["partitioned"])
    )
