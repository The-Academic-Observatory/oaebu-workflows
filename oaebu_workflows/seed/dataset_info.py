...
def get_dataset_info(api: ObservatoryApi):
    ...
    dataset_info["DOAB Dataset"] = Dataset(
        name="DOAB Dataset",
        service="google",
    ...
    dataset_info["OAPEN Metadata Dataset"] = Dataset(
    ...
    dataset_info["ANU Press Onix Dataset"] = Dataset(
    ...
    dataset_info["UCL Press Onix Dataset"] = Dataset(
    ...
    dataset_info["Wits Press Onix Dataset"] = Dataset(
    ...
    dataset_info["UoMP Onix Dataset"] = Dataset(
    ...
    dataset_info["ANU Press Google Analytics Dataset"] = Dataset(
    ...
    dataset_info["ANU Press Google Books Sales Dataset"] = Dataset(
    ...
    dataset_info["ANU Press Google Books Traffic Dataset"] = Dataset(
    ...
    dataset_info["UCL Press Google Books Sales Dataset"] = Dataset(
    ...
    dataset_info["UCL Press Google Books Traffic Dataset"] = Dataset(
    ...
    dataset_info["UoMP Google Books Sales Dataset"] = Dataset(
    ...
    dataset_info["UoMP Google Books Traffic Dataset"] = Dataset(
    ...
    dataset_info["ANU Press JSTOR Country Dataset"] = Dataset(
    ...
    dataset_info["ANU Press JSTOR Institution Dataset"] = Dataset(
    ...
    dataset_info["UoMP JSTOR Country Dataset"] = Dataset(
    ...
    dataset_info["UoMP JSTOR Institution Dataset"] = Dataset(
    ...
    dataset_info["UCL Press JSTOR Country Dataset"] = Dataset(
    ...
    dataset_info["UCL Press JSTOR Institution Dataset"] = Dataset(
    ...
    dataset_info["Wits Press JSTOR Country Dataset"] = Dataset(
    ...
    dataset_info["Wits Press JSTOR Institution Dataset"] = Dataset(
    ...
    dataset_info["UCL Press OAPEN IRUS UK Dataset"] = Dataset(
    ...
    dataset_info["ANU Press OAPEN IRUS UK Dataset"] = Dataset(
    ...
    dataset_info["UoMP OAPEN IRUS UK Dataset"] = Dataset(
    ...
    dataset_info["OAPEN Press OAPEN IRUS UK Dataset"] = Dataset(
    ...
    dataset_info["Wits Press OAPEN IRUS UK Dataset"] = Dataset(
    ...
    dataset_info["UCL Press UCL Discovery Dataset"] = Dataset(
    ...
    dataset_info["ANU Press ONIX Workflow Dataset"] = Dataset(
    ...
    dataset_info["UCL Press ONIX Workflow Dataset"] = Dataset(
    ...
    dataset_info["Wits Press ONIX Workflow Dataset"] = Dataset(
    ...
    dataset_info["UoMP ONIX Workflow Dataset"] = Dataset(
    ...
    dataset_info["OAPEN Workflow Dataset"] = Dataset(
